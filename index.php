...
<body class="d-flex flex-column min-vh-100">
    ...
    <a class="active" href="index.html" style="margin-left:400px">Home</a>
    <a  href="card.html">Card</a>
    <a href="contact.html">Contacts</a>
    <a href="Login.html" style="margin-left:800px">Log in</a>
    <a href="Registation.html" >Sign Up</a>
    </div>
      ...
      <div class="row py-4">
        ...
        <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
          ...
          <ul class="list-unstyled mb-0">
            ...
            <li class="mb-2"><a href="#" class="flinks">Login Men</a></li>
            <li class="mb-2"><a href="#" class="flinks">Registation</a></li>
            <li class="mb-2"><a href="#" class="flinks">Payments</a></li>
          </ul>
        </div>
        <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
          <h6 class="text-uppercase font-weight-bold mb-4">Company</h6>
          <ul class="list-unstyled mb-0">
            <li class="mb-2"><a href="#" class="flinks">Login</a></li>
            <li class="mb-2"><a href="#" class="flinks">Register</a></li>
            <li class="mb-2"><a href="#" class="flinks">Wishlist</a></li>
